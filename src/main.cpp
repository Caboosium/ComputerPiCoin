...
uint256 hashGenesisBlock("0x5cd71f73638455c5608d7db8d8824274959ab4a557d78a90c3add9bf1702d106");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(505414808); // ComputerPiCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "ComputerPiCoin Signed Message:\n";
...
{
    // ComputerPiCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 420000); // ComputerPiCoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 604800; // ComputerPiCoin: 3.5 days
static const int64 nTargetSpacing = 300; // ComputerPiCoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // ComputerPiCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // ComputerPiCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // ComputerPiCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x3ed3538419a6a5d48a280dfd73c9a8724c878b4887163b75afb8c7cc5c7cf4b9");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("083c8e30f08aa8ae1b66fbafa4ca52f9d1c2934687a1791e912cddb676a734b645b713a9550dc426cabdc42f81f1059508a9c929a2d4d28f052013bdf86adeee78") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1521529638;
        block.nBits    = 505414808;
        block.nNonce   = 3385414696;

        if (fTestNet)
        {
            block.nTime    = 1521529638;
            block.nNonce   = 1898998430;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x0ff79914bb0668527c7c685c0dda410e92fc31f30043a42e9f3e37e0af46630a"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // ComputerPiCoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    //// debug print
    printf("ComputerPiCoin RPCMiner:\n");
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("ComputerPiCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("ComputerPiCoinMiner : ProcessBlock, block not accepted");
    }
